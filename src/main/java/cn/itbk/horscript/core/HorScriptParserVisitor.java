...
public interface HorScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link HorScriptParser#slice}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSlice(HorScriptParser.SliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPostSelfExpr(HorScriptParser.PostSelfExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPreSelfExpr(HorScriptParser.PreSelfExprContext ctx);
	/**
